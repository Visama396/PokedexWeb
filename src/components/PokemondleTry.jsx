...
export default function PokemondleTry({ pokemon, pokeTry, language }) {
	...
	return (
		<tr className='wrap-break-word'>
			<td className='size-16 xl:size-32 rounded-sm xl:rounded-md' style={{ backgroundColor: compareTypes(pokeTryData.types, pokemon.types, 0) }}><p>{pokeTryData.types[0]}</p></td>
			<td className='size-16 xl:size-32 rounded-sm xl:rounded-md' style={{ backgroundColor: compareTypes(pokeTryData.types, pokemon.types, 1) }}><p>{pokeTryData.types[1] ?? '-'}</p></td>
			...
			<td className='size-16 xl:size-32 rounded-sm xl:rounded-md' style={{ backgroundColor: compareAbilities(pokeTryData.abilities, pokemon.abilities, 0) }}><p>{pokeTryData.abilities[0]}</p></td>
			<td className='size-16 xl:size-32 rounded-sm xl:rounded-md' style={{ backgroundColor: compareAbilities(pokeTryData.abilities, pokemon.abilities, 1) }}><p>{pokeTryData.abilities[1] ?? '-'}</p></td>
			<td className='size-16 xl:size-32 rounded-sm xl:rounded-md' style={{ backgroundColor: compareAbilities(pokeTryData.abilities, pokemon.abilities, 2) }}><p>{pokeTryData.abilities[2] ?? '-'}</p></td>
